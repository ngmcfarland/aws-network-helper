help_message="""Hey there! I'm a chat bot that's designed to help you troubleshoot those annoying AWS network problems that are preventing you from connecting to your EC2 or RDS instances. Just by asking me a simple question, or making a simple statement, you can give me enough information to go check the health of your instances as well as your Network ACLs and Security Groups.
